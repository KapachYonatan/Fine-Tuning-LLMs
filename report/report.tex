...
\textit{[TODO: For \texttt{Qwen2.5-7B-Instruct} and
\texttt{Mistral-7B-Instruct-v0.3}: identify all tokens that may participate
in Hebrew text (Hebrew characters, numbers, punctuation). Describe the
identification strategy. Refer to the submitted JSON files.]}

% ----------------------------------------------------------
\subsection{Implementation}
% ----------------------------------------------------------

\textit{[TODO: Brief description of how constrained decoding was implemented
(logit masking / token-level beam filtering / etc.).]}

% ----------------------------------------------------------
\subsection{Results and Discussion}
% ----------------------------------------------------------

\textit{[TODO: 10 English queries with unconstrained and constrained outputs for
both models. Discussion: Is the Hebrew text meaningful? Does it relate to the
question? Do the models differ? Are certain languages favoured?]}
...
\textit{[TODO: Describe the training data (English prompt $\to$ Hebrew answer
pairs): source, creation method, and confirmation that none of the 20 evaluation
inputs appear in the training set.]}

% ----------------------------------------------------------
\subsection{Fine-Tuning Procedure}
% ----------------------------------------------------------

\textit{[TODO: Describe the fine-tuning setup: LoRA configuration (rank,
$\alpha$, target modules), training hyper-parameters, and the chat-template
usage for both training and inference.]}

% ----------------------------------------------------------
\subsection{Evaluation}
% ----------------------------------------------------------

\textit{[TODO: Run the original and fine-tuned \texttt{Qwen2.5-1.5B-Instruct}
on all 20 evaluation inputs. Present outputs side by side. Discuss whether the
fine-tuned model answers in Hebrew and whether the answers are relevant.]}
